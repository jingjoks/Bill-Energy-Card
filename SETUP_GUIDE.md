...
## ขั้นที่ 6 (ตัวเลือก) — ผูก input_number เข้ากับการ์ด แก้วัน/ชั่วโมงได้จากในตัวการ์ดเลย

เปิด **แก้ไขการ์ด** → เลื่อนหา section **"การตั้งค่ารอบบิล (ตัวเลือก)"** → เลือก `input_number.pea_cutoff_day` และ `input_number.pea_cutoff_hour` ที่สร้างไว้ในขั้นที่ 3
